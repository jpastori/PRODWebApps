...
<!--- Program: documentpickupservice.cfm --->
<!--- By: JOHN R. PASTORI --->
<!--- Date Written: 02/12/2012 --->
<!--- Date in Production: 02/12/2012 --->
<!--- Module: Facilities - Work Requests - Document Pick Up Service Submission --->
<!-- Last modified by John R. Pastori on 02/12/2012 using ColdFusion Studio. -->

<CFOUTPUT>
<CFSET SCREENPROGRAMNAME = "documentpickupservice.cfm">
<CFSET RESPONSEPROGRAMNAME = "documentpickupservice.cfm">
<CFSET REPORTTITLE = "Document Pick Up Service Submission">
 ...
 --->
	...
	<CFQUERY name="LookupMoveRequests" datasource="#application.type#FACILITIES">
		SELECT	MR.MOVEREQUESTID, MR.MOVEREQUESTWRID, MR.MOVETYPEID, MT.MOVETYPENAME, MR.ITEMDESCRIPTION, MR.STATENUMBER,
				...
				MR.FROMROOMID, FROMBN.BUILDINGNAME AS CURRENTBUILDING, FROMLOC.ROOMNUMBER AS CURRENTROOM, MR.FROMJACKNUMBERID,
				FROMWJ.WALLDIRECTION || ' - ' || FROMWJ.JACKNUMBER || ' - ' || FROMWJ.PORTNUMBER AS FROMJACK,
				MR.TOROOMID, TOBN.BUILDINGNAME AS DESTBUILDING, TOLOC.ROOMNUMBER AS DESTROOM, MR.TOJACKNUMBERID,
...
<CFIF LookupMoveRequests.MOVETYPEID EQ 4>
	<TR>
		<TH align="LEFT" colspan="2">
			<H2>Pick Up Confidential Materials for Disposal</H2>
		</TH>
	</TR>
	<TR>
		<TD align="LEFT" valign="top" colspan="2">
			<COM>All materials must be enclosed in a sealed box and marked &quot;DESTROY&quot;.</COM><BR /><BR />
		</TD>
	</TR>
	<TR>
		<TD align="LEFT" valign="top">Number of Boxes:</TD>
		<TD align="LEFT" valign="top">
			<CFINPUT type="text" name="number_of_confidential" size="10" value="#LookupMoveRequests.NUMBEROFBOXES#" tabindex="28">
		</TD>
	</TR>
	<TR>
		<TD align="LEFT" valign="top" colspan="2"><STRONG>Current Location</STRONG></TD>
	</TR>
	<TR>
		<TD align="LEFT" valign="top">Building or Location:</TD>
		<TD align="LEFT" valign="top">
			<CFINPUT type="text" name="confidential_location" size="50" value="#LookupMoveRequests.CURRENTBUILDING#" tabindex="29">
		</TD>
	</TR>
	<TR>
		<TD align="LEFT" valign="top">Room Number:</TD>
		<TD align="LEFT" valign="top">
			<CFINPUT type="text" name="confidential_room_number" size="20" value="#LookupMoveRequests.CURRENTROOM#" tabindex="30">
		</TD>
	</TR>
	<TR>
...
<CFELSE>
	<TR>
		<TH align="LEFT" colspan="2">
			<H2>Pick Up Records for Storage</H2>
		</TH>
	</TR>
	<TR>
		<TD align="LEFT" valign="top" colspan="2">
			<COM>All boxes must have destruction date clearly marked on the outside.</COM><BR /><BR />
		</TD>
	</TR>
	<TR>
		<TD align="LEFT" valign="top">Number of Boxes:</TD>
		<TD align="LEFT" valign="top">
			<CFINPUT type="text" name="number_of_record" size="10" value="#LookupMoveRequests.NUMBEROFBOXES#" tabindex="31">
		</TD>
	</TR>
	<TR>
		<TD align="LEFT" valign="top" colspan="2"><STRONG>Current Location</STRONG></TD>
	...
	<TR>
		<TD align="LEFT" valign="top">Building or Location:</TD>
		<TD align="LEFT" valign="top">
			<CFINPUT type="text" name="record_location" size="50" value="#LookupMoveRequests.CURRENTBUILDING#" tabindex="32">
		</TD>
	</TR>
	<TR>
		<TD align="LEFT" valign="top">Room Number:</TD>
		<TD align="LEFT" valign="top">
			<CFINPUT type="text" name="record_room_number" size="20" value="#LookupMoveRequests.CURRENTROOM#" tabindex="33">
		</TD>
	</TR>
	<TR>
		<TD align="LEFT" valign="top" colspan="2"><STRONG>Destination</STRONG></TD>
	</TR>
	<TR>
		<TD align="LEFT" valign="top">Building or Location:</TD>
		<TD align="LEFT" valign="top">
			<CFINPUT type="text" name="record_destination" size="50" value="#LookupMoveRequests.DESTBUILDING#" tabindex="34">
		</TD>
	</TR>
	<TR>
		<TD align="LEFT" valign="top">Room Number:</TD>
		<TD align="LEFT" valign="top">
			<CFINPUT type="text" name="record_room_number_destination" size="20" value="#LookupMoveRequests.DESTROOM#" tabindex="35">
		</TD>
	</TR>
</CFIF>
	<TR>
	...
	<TR>
		<TH align="LEFT" colspan="2">
			<H2>Additional Information (please specify)</H2>
		</TH>
	</TR> 
	
	<TR>
		<TD align="LEFT" valign="top" colspan="2">
			<TEXTAREA name="other_description" cols="30" rows="5" tabindex="36">#LookupMoveRequests.ITEMDESCRIPTION#</TEXTAREA>
		</TD>
	</TR>
	<TR>
		<TD align="LEFT" colspan="2">
			<INPUT type="Submit" name="Submit" value="Submit" class="button" tabindex="37" /> &nbsp;&nbsp;<BR /> 
</CFFORM>
<CFFORM action="/#application.type#apps/facilities/#SCREENPROGRAMNAME#" method="POST">
			<INPUT type="Submit" value="Cancel" tabindex="38" />
		</TD>
</CFFORM>
	</TR>
</TABLE>

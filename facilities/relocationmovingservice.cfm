...
<!--- Program: relocationmovingservice.cfm --->
<!--- By: JOHN R. PASTORI --->
<!--- Date Written: 02/11/2012 --->
<!--- Date in Production: 02/11/2012 --->
<!--- Module: Facilities - Work Requests - Relocation &amp; Moving Service Submission --->
<!-- Last modified by John R. Pastori on 02/11/2012 using ColdFusion Studio. -->

<CFOUTPUT>
<CFSET SCREENPROGRAMNAME = "relocationmovingservice.cfm">
<CFSET RESPONSEPROGRAMNAME = "relocationmovingservice.cfm">
<CFSET REPORTTITLE = "Relocation &amp; Moving Service Submission">
...
<CFFORM name="WORKREQUEST" action="/#application.type#apps/facilities/#RESPONSEPROGRAMNAME#" method="post" onsubmit="return check_form(this);">	
	...
	<TR>
		...
		<TD align="LEFT" valign="top">
			<CFINPUT type="text" name="item" size="50" value="#LookupMoveRequests.ITEMDESCRIPTION#" tabindex="28">
		</TD>
	</TR>
	<TR>

...
<!--- Program: divisioncurrassignedreport.cfm --->
<!--- By: JOHN R. PASTORI --->
<!--- Date Written: 07/12/2012 --->
<!--- Date in Production: 07/12/2012 --->
<!--- Module: IDT Hardware Inventory Current Assignment by Division Number Report --->
...
<CFOUTPUT>
	<table width="100%" align="center" border="3">
		<tr align="center">
			<th align="center"><h1>IDT Hardware Inventory Current Assignment by Division Number Report</h1></th>
		</tr>
	</table>
...
<CFFORM action="/#application.type#apps/hardwareinventory/hardwareinventorydbreports.cfm?PROCESS=REPORT" method="POST">
	...
	<CFLOOP query="LookupHardware">
		...
		<CFQUERY name="LookupHardwareWarranty" datasource="#application.type#HARDWARE" blockfactor="100">
		...
		<CFQUERY name="LookupRecordModifier" datasource="#application.type#LIBSHAREDDATA" blockfactor="100">

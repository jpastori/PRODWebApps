...
<!--- Program: opcounttypedescr.cfm --->
<!--- By: JOHN R. PASTORI --->
<!--- Date Written: 07/13/2012 --->
<!--- Date in Production: 07/13/2012 --->
<!--- Module: Process Information to IDT Hardware Inventory Operational Count By Type/Description Report --->
...
<CFOUTPUT>
	...
	<table width="100%" align="center" border="3">
		<tr align="center">
			<th align="center"><h1>IDT Hardware Inventory Operational Count By Type/Description Report</h1></th>
		</tr>
	</table>
...
<CFFORM action="/#application.type#apps/hardwareinventory/hardwareinventorydbreports.cfm?PROCESS=REPORT" method="POST">
	...
	<CFLOOP query="LookupHardware">
		<CFIF #LookupHardware.EQUIPMENTTYPE# EQ #EQUIPTYPE#>
			<CFIF #LookupHardware.EQUIPMENTDESCRIPTION# EQ #EQUIPDESCR#>

...
<!--- Program: publicusebytypelocreport.cfm --->
<!--- By: JOHN R. PASTORI --->
<!--- Date Written: 07/13/2012 --->
<!--- Date in Production: 07/13/2012 --->
<!--- Module: IDT Hardware Inventory Public Use By Type/Location Report --->
...
<CFOUTPUT>
	<table width="100%" align="center" border="3">
		<tr align="center">
			<th align="center"><h1>IDT Hardware Inventory #FORM.ReportType# Public Use By Type/Location Report</h1></th>
		</tr>
	</table>
...
<CFFORM action="/#application.type#apps/hardwareinventory/hardwareinventorydbreports.cfm?PROCESS=REPORT" method="POST">
	...
	<CFLOOP query="LookupHardware">
		...
		<CFIF PUBLICHEADER NEQ #LookupHardware.FULLNAME#>
			<CFSET PUBLICHEADER = #LookupHardware.FULLNAME#>
		<tr>
			<th align="left" nowrap><h2>#LookupHardware.FULLNAME#</h2></th>
		</tr>
		</CFIF>
		<tr>
			...
			<td align="left"><div>#LookupHardware.EQUIPMENTDESCRIPTION#</div></td>
			<td align="left"><div>#LookupHardware.MODELNAME#</div></td>
			<td align="left"><div>#LookupHardware.MODELNUMBER#</div></td>

...
<!--- Program: speedsizesreport.cfm --->
<!--- By: JOHN R. PASTORI --->
<!--- Date Written: 07/13/2012 --->
<!--- Date in Production: 07/13/2012 --->
<!--- Module: Process Information to IDT Hardware Inventory Speed/Sizes Report --->
...
<CFOUTPUT>
	<table width="100%" align="center" border="3">
		<tr align="center">
			<th align="center"><h1>IDT Hardware Inventory Speed/Sizes Report</h1></th>
		</tr>
	</table>
...
<CFFORM action="/#application.type#apps/hardwareinventory/hardwareinventorydbreports.cfm?PROCESS=REPORT" method="POST">
		...
		<tr>
			...
			<th align="CENTER" valign="BOTTOM">Speed</th>
			...
			<th align="CENTER" valign="BOTTOM">Current Assign</th>
	...
	<CFLOOP query="LookupHardware">
		...
		<CFQUERY name="ListHardwareSizes" datasource="#application.type#HARDWARE">
			...
			WHERE	HARDWARESIZES.BARCODENUMBER = <CFQUERYPARAM value="#LookupHardware.BARCODENUMBER#" cfsqltype="CF_SQL_VARCHAR"> AND 
		...
		<tr>
			...
			<td align="CENTER" valign="TOP"><div>#LookupHardware.SPEEDNAME#</div></td>

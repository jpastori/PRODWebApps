...
<!--- Date in Production: 11/28/2012 --->
<!--- Module: IDT Service Request Home Page--->
<!-- Last modified by John R. Pastori on 06/30/2016 using ColdFusion Studio. -->

<cfset AUTHOR_NAME = "John R. Pastori">
<cfset AUTHOR_EMAIL = "jpastori@mail.sdsu.edu">
<cfset DOCUMENT_URI = "/#application.type#apps/servicerequests/index.cfm">
...
<cfset Client.ACCESSINGSERVICEREQUESTS = "YES">
...
<table width="100%" border="5" cellspacing="0" cellpadding="0" align="center">
	<tr>
		<td align="center" valign="TOP"><h1>IDT Service Request Application</h1></td>
	</tr>
</table>
	...
	<tr>
     ...
     <tr>
		<td align="LEFT" valign="top">
          	<br>
			<a href="/#application.type#apps/servicerequests/custsradd.cfm">Add </a> Customer Service Requests<br>
		...
		<td align="LEFT" valign="top">
          	<br />
			<a href="/#application.type#apps/servicerequests/custqueryreport.cfm">Customer Query</a> Report or
               <a href="/#application.type#apps/servicerequests/srunitcustreport.cfm">Unit Liaison Query</a> Report
               <br />
			Customer <a href="/#application.type#apps/servicerequests/custnetworkvoiceworeport.cfm?PROCESS=NETWORK">Network Work Order</a> Report or 
               Customer <a href="/#application.type#apps/servicerequests/custnetworkvoiceworeport.cfm?PROCESS=VOICE">Voice Work Order</a> Report
          </td>
	</tr>
...
<cfif #Client.ProcessFlag# EQ "Yes">
	<tr>
		<td align="LEFT" valign="top">
			<a href="/#application.type#apps/servicerequests/lookupcontactsprobleminfo.cfm?PROCESS=ADD">Add</a> New SR or
			<a href="/#application.type#apps/servicerequests/servicerequestinfo.cfm?PROCESS=MODIFY">Modify</a> an Existing SR<br /><br />
		<cfif #Client.SecurityFlag# EQ "Yes" OR #Client.MaintFlag# EQ "Yes">
			<a href="/#application.type#apps/servicerequests/srstaffassignloop.cfm">Add Assignments </a> via Loop<br />
			<a href="/#application.type#apps/servicerequests/lookupservicerequestinfo.cfm?PROCESS=ADD">Add Assignments</a> via Single <br />
 		</cfif>
         	<br />
               <a href="/#application.type#apps/servicerequests/claimednotcomplkuplist.cfm?LIST_LOOKUP=LOOKUP"> Modify SR Comments</a> via <strong>List</strong> <br /><br /><br /><br /><br />
			<a href="/#application.type#apps/servicerequests/lookupservicerequestinfo.cfm?PROCESS=MODIFYDELETE">Modify SR Comments</a> via <strong>Single</strong><br /><br /><br />
			<a href="/#application.type#apps/servicerequests/staffassignsmodloop.cfm?DISPLAYTYPE=BASIC">Modify SR Comments</a> via Loop<br />
			<a href="/#application.type#apps/servicerequests/staffassignsmodloop.cfm?DISPLAYTYPE=EXTRA">Modify SR Comments</a> via Loop with Extra Info
			<br />
		</td>
		<td align="LEFT" valign="top">
          <cfif #Client.ProcessFlag# EQ "Yes">
          	SR <a href="/#application.type#apps/servicerequests/srreviewreport.cfm">Review Report</a><br /><br />
          </cfif>

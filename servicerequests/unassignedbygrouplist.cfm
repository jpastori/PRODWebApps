...
<!--- Program: unassignedbygrouplist.cfm --->
<!--- By: JOHN R. PASTORI --->
<!--- Date Written: 08/13/2012 --->
<!--- Date in Production: 08/13/2012 --->
...
<cfset DOCUMENT_URI = "/#application.type#apps/servicerequests/unassignedbygrouplist.cfm">
...
<!--- 
**********************************************************************************************************
* The following code is the Group Assigned Lookup Process for SRDisplay List Unassigned By Group Report. *
**********************************************************************************************************
 --->
...
<cfform name="LOOKUP" onsubmit="return validateGROUPReqFields();" action="/#application.type#apps/servicerequests/unassignedbygrouplist.cfm?LOOKUPGROUPID=FOUND" method="POST">
		<tr>
...
<!--- 
**********************************************************************************************************************
* The following code is the Group Assigned Records Selection Process for SR Display List Unassigned By Group Report. *
**********************************************************************************************************************
 --->
	...
	<cfif #LookupServiceRequests.RecordCount# EQ 0 AND #LookupGroupStaffAssignments.RecordCount# EQ 0>
		...
		<meta http-equiv="Refresh" content="0; URL=/#application.type#apps/servicerequests/unassignedbygrouplist.cfm" />
		<cfexit>
	<cfelse>
     	<cfset COUNTER = 0>
...
<cfif #FORM.REPORTSORTORDER# GT 0>
...
<table width="100%" border="0">
	<tr>
<cfform action="/#application.type#apps/servicerequests/unassignedbygrouplist.cfm" method="POST">
		<td align="left">
			<input type="image" src="/images/buttonCancel.jpg" value="Cancel" alt="Cancel" tabindex="1" /><br />
		</td>
</cfform>

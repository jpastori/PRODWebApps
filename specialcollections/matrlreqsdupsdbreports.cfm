...
<!--- Program: matrlreqsdupsdbreports.cfm --->
<!--- By: JOHN R. PASTORI --->
<!--- Date Written: 01/23/2009 --->
<!--- Date in Production: 01/23/2009 --->
<!--- Module: Special Collections - Material Requests & Duplications Detail Reports --->
<!-- Last modified by John R. Pastori on 01/23/2009 using ColdFusion Studio. -->

<CFSET AUTHOR_NAME = "John R. Pastori">
<CFSET AUTHOR_EMAIL = "pastori@rohan.sdsu.edu">
<CFSET DOCUMENT_URI = "/#application.type#apps/specialcollections/matrlreqsdupsdbreports.cfm">
<CFSET CONTENT_UPDATED = "January 23, 2009">
<CFINCLUDE template = "../programsecuritycheck.cfm">

<HTML>
<HEAD>
	<TITLE>Special Collections - Material Requests & Duplications Detail Reports</TITLE>
...
<!--- 
**************************************************************************************************
* The following code is the Look Up Process for Material Requests & Duplications Detail Reports. *
**************************************************************************************************
 --->
...
<CFIF NOT IsDefined('URL.LOOKUPMATRLREQSDUPSRECORD')>
	...
	<TABLE width="100%" align="LEFT" border="3">
		<TR align="center">
			<TH align="center">
				<H1>Special Collections - Material Requests & Duplications Detail Reports Selection Lookup</H1>
			</TH>
		</TR>
	</TABLE>
	<BR /><BR /><BR />
...
<CFFORM name="LOOKUP" action="/#application.type#apps/specialcollections/matrlreqsdupsdbreports.cfm?LOOKUPMATRLREQSDUPSRECORD=FOUND" method="POST" ENABLECAB="Yes">
...
<!--- 
************************************************************************************
* The following code displays the Material Requests & Duplications Detail Reports. *
************************************************************************************
 --->
 
	<CFSET SORTORDER = ARRAYNEW(1)>
	<CFSET SORTORDER[1] = 'C.COLLECTIONNAME~ R.FULLNAME~ MRD.TOPIC'>
	<CFSET SORTORDER[2] = 'SERVICEDATE~ R.FULLNAME~ MRD.TOPIC'>
	<CFSET SORTORDER[3] = 'S.SERVICENAME~ C.COLLECTIONNAME'>
	...
	<CFQUERY name="LookupMatrlReqsDups" datasource="#application.type#SPECIALCOLLECTIONS" blockfactor="100">
		SELECT	MRD.MRDID, MRD.RESEARCHERID, R.FULLNAME, MRD.TOPIC, MRD.COLLECTIONID, C.COLLECTIONNAME, MRD.CALLNUMBER, MRD.BOXNUMBER,
				MRD.SERVICEDATE, TO_CHAR(MRD.SERVICEDATE, 'YYYY-MM-DD') AS CHARSERVICEDATE, MRD.ASSISTANTNAMEID, MRD.SECONDASSISTANTNAMEID,
				MRD.SERVICEID, S.SERVICENAME, MRD.APPROVEDBYID, MRD.TOTALCOPIESMADE, MRD.COSTFORSERVICE, MRD.PAIDTYPEID, MRD.COMMENTS,
				MRD.MODIFIEDBYID, MRD.MODIFIEDDATE, R.FULLNAME || ' - ' || MRD.TOPIC AS RNAMETOPIC
	...
	<CFIF #LookupMatrlReqsDups.RecordCount# EQ 0>
		...
		<META http-equiv="Refresh" content="0; URL=/#application.type#apps/specialcollections/matrlreqsdupsdbreports.cfm" />
		<CFEXIT>
	...
	<CFELSE>
		...
		<CFSWITCH expression = #FORM.REPORTCHOICE#>
			...
			<CFCASE value = 1>
				<CFINCLUDE template="collectionnamereport.cfm">
			</CFCASE>

			<CFCASE value = 2>
				<CFINCLUDE template="servicedatereport.cfm">
			</CFCASE>

			<CFCASE value = 3>
				<CFINCLUDE template="servicenamereport.cfm">
			</CFCASE>

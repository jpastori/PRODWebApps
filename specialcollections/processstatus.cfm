...
<!--- Module: Process Information to Special Collections - Status --->
...
<HTML>
<HEAD>
	<TITLE>Process Information to Special Collections - Status</TITLE>
...
<CFIF FORM.PROCESSSTATUS EQ "ADD" OR FORM.PROCESSSTATUS EQ "MODIFY">
	<CFQUERY name="ModifyStatus" datasource="#application.type#SPECIALCOLLECTIONS">
		UPDATE	STATUS
	...
	<CFIF FORM.PROCESSSTATUS EQ "ADD">
		<H1>Data ADDED!</H1>
		<META http-equiv="Refresh" content="1; URL=/#application.type#apps/specialcollections/status.cfm?PROCESS=ADD" />
	<CFELSE>
		<H1>Data MODIFIED!</H1>
		<META http-equiv="Refresh" content="1; URL=/#application.type#apps/specialcollections/status.cfm?PROCESS=MODIFYDELETE" />
	</CFIF>
</CFIF>

<CFIF FORM.PROCESSSTATUS EQ "DELETE" OR FORM.PROCESSSTATUS EQ "CANCELADD">
	<CFQUERY name="DeleteStatus" datasource="#application.type#SPECIALCOLLECTIONS">
		DELETE FROM	STATUS
		WHERE 		STATUSID = #val(Cookie.STATUSID)#
	</CFQUERY> 
	<H1>Data DELETED!</H1>
